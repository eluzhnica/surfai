...
from surfai import Model
from surfai.api_requestor import APIRequestor
...
def test_requestor_cycle_sessions(mocker: MockerFixture) -> None:
    ...
    # with other tests
    from surfai.api_requestor import _thread_context
    ...
    mocker.patch("surfai.api_requestor._make_session", lambda: mock_session)
    ...
    mocker.patch("surfai.api_requestor.MAX_SESSION_LIFETIME_SECS", 0)
    ...
    mocker.patch("surfai.api_requestor._make_session", lambda: mock_session_2)
    api_requestor.request_raw("get", "http://example.com")
