...
class OpenAIError(Exception):
    def __init__(
        ...
        if http_body and hasattr(http_body, "decode"):
            try:
                ...
                http_body = (
                    ...
                    "Please contact us through our help center at help.surfai.com.>"
                )
        ...
        self.organization = self.headers.get("surfai-organization", None)
    ...
    def construct_error_object(self):
        ...
        return surfai.api_resources.error_object.ErrorObject.construct_from(
